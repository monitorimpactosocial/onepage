...
// ── Microsoft Graph API ─────────────────────────────────────
const GRAPH_CONFIG = {
  clientId:    'TU_CLIENT_ID_AQUI',        // Azure App Registration → Application ID
  tenantId:    'TU_TENANT_ID_AQUI',        // Azure AD → Tenant ID
  redirectUri: window.location.origin,
  scopes:      ['Files.ReadWrite', 'Mail.Send', 'User.Read'],
  excelFileId: 'TU_FILE_ID_AQUI',          // ID del archivo Excel en OneDrive (desde la URL)
  driveId:     '',                          // Dejar vacío para usar OneDrive personal, o poner el ID del SharePoint drive
};
